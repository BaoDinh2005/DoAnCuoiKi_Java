...
public class DichVuGUI extends javax.swing.JFrame {
    ...
    private void loadDataToTable() {
        ...
        System.out.println("Số lượng dịch vụ lấy được: " + ds.size()); // Debug xem có dữ liệu ko

        DefaultTableModel model = new DefaultTableModel(
                new Object[]{"Mã DV", "Tên dịch vụ", "Giá tiền", "Đơn vị tính", "Họ tên", "Ngày nhận", "Ngày trả"},
                0
        );
